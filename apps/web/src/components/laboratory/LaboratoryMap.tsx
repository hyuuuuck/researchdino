...
const roomFlow = [
  ...
  { from: "debate", to: "strategy", step: "C3", label: "Critic-Strategy", kind: "collab", active: true },
  { from: "strategy", to: "experiment", step: "C4", label: "Experiment Strategy", kind: "collab", active: true },
